      ...
      <div className='grid md:grid-cols-2 gap-20 items-center'>
        <div>
          ...
          <p className='text-green-500 pt-5' data-aos="flip-right">
            I'm a web designer, specializing in HTML, CSS, TypeScript, JavaScript, and Next.js. 
            I'm also proficient in Tailwind CSS for uniqueness in styling and design. 
            Focusing on crafting user experiences and design systems for software, web, and mobile products.
            I'm passionate about applying consumer psychology for an interaction science-backed approach.
          </p>
        </div>
